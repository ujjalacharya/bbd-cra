  ...
  componentDidMount() {
    setTimeout(() => {
      firebase
        ...
        .ref("apply")
        .once("value", data => {
          this.setState({data: firebaseLooper(data)})
        });
    }, 0);
  }
            ...
            <thead>
                <tr className="tbl-title">
                    <th scope="col" onClick={() => this.onSort('id')}>
                        S.N. 
                        <i id="id-arrow-up" className="ion-android-arrow-up" style={{display:'none'}} /> 
                        <i id="id-arrow-down" className="ion-android-arrow-down" />
                    </th>
                    <th scope="col" onClick={() => this.onSort('title')}>
                        Email
                        <i id="title-arrow-up" className="ion-android-arrow-up" style={{display:'none'}} /> 
                        <i id="title-arrow-down" className="ion-android-arrow-down" />
                    </th>
                    <th scope="col" onClick={() => this.onSort('address')}>
                        First Name
                        <i id="address-arrow-up" className="ion-android-arrow-up" style={{display:'none'}} /> 
                        <i id="address-arrow-down" className="ion-android-arrow-down" />
                    </th>
                    <th scope="col" onClick={() => this.onSort('price')}>
                        Last Name
                        <i id="price-arrow-up" className="ion-android-arrow-up" style={{display:'none'}} /> 
                        <i id="price-arrow-down" className="ion-android-arrow-down" />
                    </th>
                    <th scope="col" onClick={() => this.onSort('status')}>
                        Phone
                        <i id="status-arrow-up" className="ion-android-arrow-up" style={{display:'none'}} /> 
                        <i id="status-arrow-down" className="ion-android-arrow-down" />
                    </th>
                    <th scope="col" onClick={() => this.onSort('category')}>
                        Subject
                        <i id="category-arrow-up" className="ion-android-arrow-up" style={{display:'none'}} /> 
                        <i id="category-arrow-down" className="ion-android-arrow-down" />
                    </th>
                    <th scope="col" onClick={() => this.onSort('type')}>
                        Message
                        <i id="type-arrow-up" className="ion-android-arrow-up" style={{display:'none'}} /> 
